...
namespace QLBanHang
{
    ...
    {
        DataTable tblCL;
        //Khai baos bien cuc bo Chứa dữ liệu bảng Chất liệu
        public frmChatLieu()
        {
            InitializeComponent();
        }
        ...
        {
            // Kiểm tra nút thêm coi nó có đang kick hoat hay ko
            //false không ở trạng thái kích hoạt
            if (btnThem.Enabled == false)
            {
                MessageBox.Show("Đang ở chế độ thêm mới!", "Thông báo", MessageBoxButtons.OK, MessageBoxIcon.Information);
                txtMaChatLieu.Focus();
                return;
                //return thoát khỏi dataclick
            }
        ...
        {
            string sql; //Lưu lệnh sql biến cục bộ
        ...
        // e ở đây là thông số truyền vào
