...
namespace QLBanHang.Class
{
    class functions
    {
        public static SqlConnection con; // Phương thức gợi nhớ
        ...
        //PHương thức dừng kết nối database
        public static void Disconnect()
        {
            if (con.State == ConnectionState.Open)// Con.state Khát với trạng thái open thì thực hiện
            {
                con.Close();   	//Đóng kết nối
                con.Dispose(); 	//Giải phóng tài nguyên
                con = null;// Gán connection bằng giá tri null
            }
        }
        ...
        public static void FillCombos(string sql, ComboBox cbo, string ma, string ten)
        {
            SqlDataAdapter dap = new SqlDataAdapter(sql, con);
            DataTable table = new DataTable();
            dap.Fill(table);
        ...
        // phuongw thuc hien lay du lieu secret data
        ...
        //Kiểm tra từ khóa có bị trùng hay ko
        ...
        public static void RunSQL(string sql)
        {
            ...
            cmd.Dispose();//Giải phóng bộ nhớ (Taif nguyen) 
            cmd = null;
        }
        //Xóa dữ liêu
